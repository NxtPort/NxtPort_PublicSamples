...
namespace NxtPort.Sample.Winforms.CallApiImplicitFlow
{
    public partial class Form1 : Form
    {
        ...
        private void btStart_Click(object sender, EventArgs e)
        {
            ...
            //Make the URL based on STS url, clientid, scope and redirecturl.
        ...
        {
            //After entering correct credentials the browser redirects to the redirecturl.
            if (e.Url.ToString().StartsWith(Config.REDIRECTURI))
            {
                var dict = e.Url.ToString().Replace(Config.REDIRECTURI + "#", "").Replace("?", "").Split('&')
